...
export declare const SocketEvents: {
    readonly LobbyJoin: "lobby:join";
    readonly LobbyReady: "lobby:ready";
    readonly LobbyRematch: "lobby:rematch";
    readonly WebrtcSignal: "webrtc:signal";
    readonly GameDrawDetected: "game:draw_detected";
    readonly LobbyState: "lobby:state";
    readonly LobbyError: "lobby:error";
    readonly WebrtcInit: "webrtc:init";
    readonly GameStart: "game:start";
    readonly GameDraw: "game:draw";
    readonly GameResult: "game:result";
};
