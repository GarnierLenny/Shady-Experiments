...
export type LobbyStatus = 'waiting' | 'ready' | 'countdown' | 'draw' | 'finished';
...
export type DuelEndReason = 'draw' | 'false_start' | 'timeout' | 'opponent_left';
