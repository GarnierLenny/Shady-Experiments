...
import { normalizeLobbyId } from '@shadyexperiments/shared';
...
export async function generateMetadata({
  ...
  // basePath '/standoff' (next.config) is not auto-applied to metadata image URLs.
  const img = `/standoff/api/og/invite?code=${encodeURIComponent(code)}${
